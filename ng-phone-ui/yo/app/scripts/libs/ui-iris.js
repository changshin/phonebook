...
(function( $, undef ){
	...
	_html = ''
		+ '<div class="iris-picker">'
			+ '<div class="iris-picker-inner">'
				+ '<div class="iris-square">'
					+ '<a class="iris-square-value" href="#"><span class="iris-square-handle ui-slider-handle"></span></a>'
					+ '<div class="iris-square-inner iris-square-horiz"></div>'
					+ '<div class="iris-square-inner iris-square-vert"></div>'
				+ '</div>'
				+ '<div class="iris-slider iris-strip">'
					+ '<div class="iris-slider-offset"></div>'
				+ '</div>'
			+ '</div>'
		+ '</div>';
	_css = '.iris-picker{display:block;position:relative}'
		+ '.iris-picker,.iris-picker *{-moz-box-sizing:content-box;-webkit-box-sizing:content-box;box-sizing:content-box}'
		+ 'input+.iris-picker{margin-top:4px}'
		+ '.iris-error{background-color:#ffafaf}'
		+ '.iris-border{border-radius:3px;border:1px solid #aaa;width:200px;background-color:#fff}'
		+ '.iris-picker-inner{position:absolute;top:0;right:0;left:0;bottom:0}'
		...
		+ '{border-radius:3px;box-shadow:inset 0 0 5px rgba(0,0,0,.4);height:100%;width:12.5%;float:left;margin-right:5%}'
		...
		+ '.iris-ie-lt9 .iris-square .ui-slider-handle{outline:1px solid #aaa;background-color:#fff;-ms-filter:"alpha(Opacity=30)"}'
		+ '.iris-ie-lt9 .iris-square .iris-square-handle{background:0;border:3px solid #fff;-ms-filter:"alpha(Opacity=50)"}'
		+ '.iris-picker .iris-strip{margin-right:0;position:relative}'
		+ '.iris-picker .iris-strip .ui-slider-handle'
		+ ' {position:absolute;background:0;margin:0;right:-3px;left:-3px;border:4px solid #aaa;border-width:4px 3px;width:auto;height:6px;border-radius:4px;box-shadow:0 1px 2px rgba(0,0,0,.2);opacity:.9;z-index:5;cursor:ns-resize}'
		...
		+ '.iris-picker .iris-slider-offset{position:absolute;top:11px;left:0;right:0;bottom:-3px;width:auto;height:auto;background:transparent;border:0;border-radius:0}'
		+ '.iris-picker .iris-square-handle'
		// 2015-11-18, Chang added display:none because when product toolbox is dragging the circle is out of box
		+ '{display:none;background:transparent;border:5px solid #aaa;border-radius:50%;border-color:rgba(128,128,128,.5);box-shadow:none;width:12px;height:12px;position:absolute;left:-10px;top:-10px;cursor:move;opacity:1;z-index:10}'
		...
		+ '.iris-square-handle,.ui-slider-handle{border:0;outline:0}';
